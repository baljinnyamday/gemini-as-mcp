...
export default withMermaid(
  defineConfig({
    ...
    head: [
      ["link", { rel: "icon", href: "/gemini-as-mcp/favicon.ico" }],
      ["link", { rel: "icon", type: "image/png", sizes: "128x128", href: "/gemini-as-mcp/icon.png" }],
      ["link", { rel: "apple-touch-icon", sizes: "128x128", href: "/gemini-as-mcp/icon.png" }],
    ],
    ...
    themeConfig: {
      ...
      socialLinks: [{ icon: "github", link: "https://github.com/baljinnyamday/gemini-as-mcp" }],
