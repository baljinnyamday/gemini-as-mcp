...
<div class="funding-card">
  ...
  <ul>
    ...
    <li><strong>API Testing Credits:</strong> Funds are used for testing various deployements of gemini-as-mcp on popular clients.</li>
  </ul>
...
<div class="support-options" style="margin: 32px auto; max-width: 600px;">
  <a href="https://github.com/sponsors/baljinnyamday" target="_blank" rel="noopener" class="support-button support-button--primary">
  ...
  <a href="https://ko-fi.com/baljinnyamday" target="_blank" rel="noopener" class="support-button support-button--secondary">
...
This project is a fork of [gemini-mcp-tool](https://github.com/jamubc/gemini-mcp-tool) by [jamubc](https://github.com/jamubc). We're grateful for their foundational work that made this project possible. If you'd like to support the original project, please consider [sponsoring jamubc](https://github.com/sponsors/jamubc).