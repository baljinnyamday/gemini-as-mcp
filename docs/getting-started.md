...
::: warning 💡 gemini-as-mcp is tested extensively with claude code
:::
...
::: info Need Help?
If you run into issues, [open an issue](https://github.com/baljinnyamday/gemini-as-mcp/issues) on GitHub.
:::